...
# BACKGROUNDS is a list of directories containing image files to be converted with grit
...
# you use in the BACKGROUNDS folders
#---------------------------------------------------------------------------------
%.s %.h : backgrounds/%.png
#---------------------------------------------------------------------------------
	grit $< -ff../backgrounds/background.grit -o$*
